  ...
  useEffect(() => {
    const fetchAnalytics = async () => {
      ...
      try {
        ...
        // Fetch analytics and courses in parallel
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">Comprehensive insights into student performance and engagement</p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Performance metrics across all your courses</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Student activity and performance over the past 5 weeks</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            {weeklyTrends.map((week, index) => (
              <div key={index} className="border rounded-lg p-4">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Student Logins</p>
                    <div className="flex items-center space-x-2">
                      <Progress value={Math.min((week.logins / 100) * 100, 100)} className="flex-1 h-2" />
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2">
                      <Progress value={Math.min((week.submissions / 25) * 100, 100)} className="flex-1 h-2" />
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2">
                      <Progress value={Math.min((week.materials / 200) * 100, 100)} className="flex-1 h-2" />
